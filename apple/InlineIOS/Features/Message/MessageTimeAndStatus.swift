...
class MessageTimeAndStatus: UIView {
  ...
  override var intrinsicContentSize: CGSize {
    CGSize(
      ...
      height: Self.measuredHeight(compatibleWith: traitCollection)
    )
  }

  static func measuredHeight(compatibleWith traits: UITraitCollection? = nil) -> CGFloat {
    ceil(ChatTypography.font(11, style: .caption2, compatibleWith: traits).lineHeight)
  }
