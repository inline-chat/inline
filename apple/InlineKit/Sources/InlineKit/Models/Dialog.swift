...
public extension Dialog {
  init(from: ApiDialog) {
    ...
    sidebarVisible = from.sidebarVisible
  }
...
public extension Dialog {
  ...
  static func sidebarVisibleFilter() -> SQLSpecificExpressible {
    Column("sidebarVisible") == nil || Column("sidebarVisible") == true
  }
