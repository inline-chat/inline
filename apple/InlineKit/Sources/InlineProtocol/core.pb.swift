...
public enum Method: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public var rawValue: Int {
    ...
    case .createSubthread: return 42
...
public struct MessageReplies: Sendable {
  ...
  public var recentReplierUserIds: [Int64] = []
...
public struct MessageActions: Sendable {
  ...
  public var rows: [MessageActionRow] = []
...
public struct MessageAction: Sendable {
  ...
  public var action: MessageAction.OneOf_Action? = nil

  public var callback: MessageActionCallback {
    get {
      if case .callback(let v)? = action {return v}
      return MessageActionCallback()
    }
    set {action = .callback(newValue)}
  }

  public var copyText: MessageActionCopyText {
    get {
      if case .copyText(let v)? = action {return v}
      return MessageActionCopyText()
    }
    set {action = .copyText(newValue)}
  }
...
public struct MessageActionResponseUi: Sendable {
  ...
  public var kind: MessageActionResponseUi.OneOf_Kind? = nil

  /// Reserved for future expandability:
  /// 2 => alert
  /// 3 => open_url
  public var toast: MessageActionToast {
    get {
      if case .toast(let v)? = kind {return v}
      return MessageActionToast()
    }
    set {kind = .toast(newValue)}
  }
...
public struct UrlPreview: @unchecked Sendable {
  ...
  public enum MediaType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [UrlPreview.MediaType] = [
      .unspecified,
      .article,
      .image,
      .video,
...
public struct UrlPreviewMedia: Sendable {
  ...
  public var media: UrlPreviewMedia.OneOf_Media? = nil
  ...
  public var externalVideo: UrlPreviewExternalVideo {
    get {
      if case .externalVideo(let v)? = media {return v}
      return UrlPreviewExternalVideo()
    }
    set {media = .externalVideo(newValue)}
  }

  /// Provider or player embed, such as YouTube or Loom when direct media is unavailable.
  public var embed: UrlPreviewEmbed {
    get {
      if case .embed(let v)? = media {return v}
      return UrlPreviewEmbed()
    }
    set {media = .embed(newValue)}
  }
  ...
  public enum OneOf_Media: Equatable, Sendable {
    ...
    /// Validated direct remote video stream that we do not own or cache as a Video yet.
    case externalVideo(UrlPreviewExternalVideo)
    /// Provider or player embed, such as YouTube or Loom when direct media is unavailable.
    case embed(UrlPreviewEmbed)
...
public struct UrlPreviewLayout: Sendable {
  ...
  public var hasLargeMedia_p: Bool = false

  /// True when clients should prefer large media where appropriate.
  public var showLargeMedia: Bool = false
...
public struct RpcCall: Sendable {
  ...
  public var getUpdates: GetUpdatesInput {
    get {
      if case .getUpdates(let v)? = input {return v}
      return GetUpdatesInput()
    }
    set {input = .getUpdates(newValue)}
  }

  public var updateMemberAccess: UpdateMemberAccessInput {
    get {
      if case .updateMemberAccess(let v)? = input {return v}
      return UpdateMemberAccessInput()
    }
  ...
  public var listBots: ListBotsInput {
    get {
      if case .listBots(let v)? = input {return v}
      return ListBotsInput()
    }
    set {input = .listBots(newValue)}
  }

  public var revealBotToken: RevealBotTokenInput {
    get {
      if case .revealBotToken(let v)? = input {return v}
      return RevealBotTokenInput()
    }
    set {input = .revealBotToken(newValue)}
  }

  public var moveThread: MoveThreadInput {
    get {
      if case .moveThread(let v)? = input {return v}
      return MoveThreadInput()
    }
  ...
  public var getMessages: GetMessagesInput {
    get {
      if case .getMessages(let v)? = input {return v}
      return GetMessagesInput()
    }
    set {input = .getMessages(newValue)}
  }

  public var updateDialogNotificationSettings: UpdateDialogNotificationSettingsInput {
    get {
      if case .updateDialogNotificationSettings(let v)? = input {return v}
      return UpdateDialogNotificationSettingsInput()
    }
  ...
  public var createSubthread: CreateSubthreadInput {
    get {
      if case .createSubthread(let v)? = input {return v}
      return CreateSubthreadInput()
    }
    set {input = .createSubthread(newValue)}
  }

  public var getBotCommands: GetBotCommandsInput {
    get {
      if case .getBotCommands(let v)? = input {return v}
      return GetBotCommandsInput()
    }
    set {input = .getBotCommands(newValue)}
  }

  public var setBotCommands: SetBotCommandsInput {
    get {
      if case .setBotCommands(let v)? = input {return v}
      return SetBotCommandsInput()
    }
    set {input = .setBotCommands(newValue)}
  }

  public var getPeerBotCommands: GetPeerBotCommandsInput {
    get {
      if case .getPeerBotCommands(let v)? = input {return v}
      return GetPeerBotCommandsInput()
    }
  ...
  public var reserveChatIds: ReserveChatIdsInput {
    get {
      if case .reserveChatIds(let v)? = input {return v}
      return ReserveChatIdsInput()
    }
    set {input = .reserveChatIds(newValue)}
  }

  public var invokeMessageAction: InvokeMessageActionInput {
    get {
      if case .invokeMessageAction(let v)? = input {return v}
      return InvokeMessageActionInput()
    }
    set {input = .invokeMessageAction(newValue)}
  }

  public var answerMessageAction: AnswerMessageActionInput {
    get {
      if case .answerMessageAction(let v)? = input {return v}
      return AnswerMessageActionInput()
    }
  ...
  public var deleteMessageAttachment: DeleteMessageAttachmentInput {
    get {
      if case .deleteMessageAttachment(let v)? = input {return v}
      return DeleteMessageAttachmentInput()
    }
  ...
  public enum OneOf_Input: Equatable, Sendable {
    ...
    case createSubthread(CreateSubthreadInput)
...
public struct RpcResult: @unchecked Sendable {
  ...
  public enum OneOf_Result: Equatable, Sendable {
    ...
    case createSubthread(CreateSubthreadResult)
...
public struct UpdateBucket: Sendable {
  ...
  public var type: UpdateBucket.OneOf_Type? = nil

  public var user: UpdateBucketUser {
    get {
      if case .user(let v)? = type {return v}
      return UpdateBucketUser()
    }
    set {type = .user(newValue)}
  }

  public var space: UpdateBucketSpace {
    get {
      if case .space(let v)? = type {return v}
      return UpdateBucketSpace()
    }
    set {type = .space(newValue)}
  }

  public var chat: UpdateBucketChat {
    get {
      if case .chat(let v)? = type {return v}
      return UpdateBucketChat()
    }
    set {type = .chat(newValue)}
  }
...
public struct GetUpdatesResult: Sendable {
  ...
  public enum ResultType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    public var rawValue: Int {
      ...
      case .empty: return 1
      case .slice: return 2
      case .tooLong: return 3
      case .UNRECOGNIZED(let i): return i
      }
    }

    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [GetUpdatesResult.ResultType] = [
      .unspecified,
      .empty,
      .slice,
      .tooLong,
...
public struct GetPeerBotCommandsResult: Sendable {
  ...
  public var bots: [PeerBotCommands] = []
...
public struct DialogNotificationSettings: Sendable {
  ...
  public enum Mode: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [DialogNotificationSettings.Mode] = [
      .unspecified,
      .all,
      .mentions,
      .none,
...
public struct ReserveChatIdsResult: Sendable {
  ...
  public var reservations: [ReservedChatId] = []
...
public struct CreateSubthreadInput: Sendable {
  ...
  public var parentChatID: Int64 = 0
...
public struct Update: Sendable {
  ...
  public enum OneOf_Update: Equatable, Sendable {
    ...
    case chatMoved(UpdateChatMoved)
    case dialogNotificationSettings(UpdateDialogNotificationSettings)
...
public struct UpdateChatMoved: Sendable {
  ...
  fileprivate var _oldSpaceID: Int64? = nil
...
extension MessageReplies: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.chatID) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.replyCount) }()
      case 3: try { try decoder.decodeSingularBoolField(value: &self.hasUnread_p) }()
      case 4: try { try decoder.decodeRepeatedInt64Field(value: &self.recentReplierUserIds) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.replyCount != 0 {
      try visitor.visitSingularInt32Field(value: self.replyCount, fieldNumber: 2)
    }
    if self.hasUnread_p != false {
      try visitor.visitSingularBoolField(value: self.hasUnread_p, fieldNumber: 3)
    }
    if !self.recentReplierUserIds.isEmpty {
      try visitor.visitPackedInt64Field(value: self.recentReplierUserIds, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: MessageReplies, rhs: MessageReplies) -> Bool {
    if lhs.chatID != rhs.chatID {return false}
    if lhs.replyCount != rhs.replyCount {return false}
    if lhs.hasUnread_p != rhs.hasUnread_p {return false}
    if lhs.recentReplierUserIds != rhs.recentReplierUserIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension MessageActions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MessageActions, rhs: MessageActions) -> Bool {
...
extension MessageActionRow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MessageActionRow, rhs: MessageActionRow) -> Bool {
...
extension MessageAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.action = .callback(v)
        }
      }()
      case 4: try {
        var v: MessageActionCopyText?
        var hadOneofValue = false
        if let current = self.action {
          hadOneofValue = true
          if case .copyText(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.action = .copyText(v)
        }
      }()
      default: break
      }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.action {
    case .callback?: try {
      guard case .callback(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .copyText?: try {
      guard case .copyText(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case nil: break
    }
...
extension MessageActionCallback: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MessageActionCallback, rhs: MessageActionCallback) -> Bool {
...
extension MessageActionCopyText: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MessageActionCopyText, rhs: MessageActionCopyText) -> Bool {
    if lhs.text != rhs.text {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension MessageActionResponseUi: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: MessageActionToast?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
          if case .toast(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if case .toast(let v)? = self.kind {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: MessageActionResponseUi, rhs: MessageActionResponseUi) -> Bool {
...
extension MessageActionToast: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MessageActionToast, rhs: MessageActionToast) -> Bool {
    if lhs.text != rhs.text {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension UrlPreview: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _mediaType: UrlPreview.MediaType? = nil
    var _displayURL: String? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _displayURL = source._displayURL
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._siteName) }()
        ...
        case 7: try { try decoder.decodeSingularInt64Field(value: &_storage._duration) }()
        case 8: try { try decoder.decodeSingularEnumField(value: &_storage._mediaType) }()
        case 9: try { try decoder.decodeSingularStringField(value: &_storage._displayURL) }()
        case 10: try { try decoder.decodeSingularStringField(value: &_storage._provider) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._displayURL {
  ...
  public static func ==(lhs: UrlPreview, rhs: UrlPreview) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._displayURL != rhs_storage._displayURL {return false}
...
extension UrlPreviewMedia: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try {
        var v: UrlPreviewExternalVideo?
        var hadOneofValue = false
        if let current = self.media {
          hadOneofValue = true
          if case .externalVideo(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.media = .externalVideo(v)
        }
      }()
      case 5: try {
        var v: UrlPreviewEmbed?
        var hadOneofValue = false
        if let current = self.media {
          hadOneofValue = true
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .externalVideo?: try {
      guard case .externalVideo(let v)? = self.media else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case .embed?: try {
      guard case .embed(let v)? = self.media else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case nil: break
    }
  ...
  public static func ==(lhs: UrlPreviewMedia, rhs: UrlPreviewMedia) -> Bool {
...
extension UrlPreviewExternalVideo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt32Field(value: &self._w) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self._h) }()
  ...
  public static func ==(lhs: UrlPreviewExternalVideo, rhs: UrlPreviewExternalVideo) -> Bool {
    if lhs.url != rhs.url {return false}
...
extension UrlPreviewEmbed: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UrlPreviewEmbed, rhs: UrlPreviewEmbed) -> Bool {
    if lhs.url != rhs.url {return false}
...
extension UrlPreviewLayout: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.hasLargeMedia_p) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.showLargeMedia) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.hasLargeMedia_p != false {
      try visitor.visitSingularBoolField(value: self.hasLargeMedia_p, fieldNumber: 1)
    }
    if self.showLargeMedia != false {
      try visitor.visitSingularBoolField(value: self.showLargeMedia, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: UrlPreviewLayout, rhs: UrlPreviewLayout) -> Bool {
    if lhs.hasLargeMedia_p != rhs.hasLargeMedia_p {return false}
    if lhs.showLargeMedia != rhs.showLargeMedia {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension RpcCall: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 27: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .getUpdates(v)
        }
      }()
      case 28: try {
        var v: UpdateMemberAccessInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
      ...
      case 34: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .listBots(v)
        }
      }()
      case 35: try {
        var v: RevealBotTokenInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .revealBotToken(v)
        }
      }()
      case 36: try {
        var v: MoveThreadInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
      ...
      case 39: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .getMessages(v)
        }
      }()
      case 40: try {
        var v: UpdateDialogNotificationSettingsInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
      ...
      case 43: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .createSubthread(v)
        }
      }()
      case 44: try {
        var v: GetBotCommandsInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .getBotCommands(v)
        }
      }()
      case 45: try {
        var v: SetBotCommandsInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .setBotCommands(v)
        }
      }()
      case 46: try {
        var v: GetPeerBotCommandsInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .getPeerBotCommands(v)
        }
      }()
      case 47: try {
      ...
      case 48: try {
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .reserveChatIds(v)
        }
      }()
      case 49: try {
        var v: InvokeMessageActionInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.input = .invokeMessageAction(v)
        }
      }()
      case 50: try {
        var v: AnswerMessageActionInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
      ...
      case 56: try {
        var v: DeleteMessageAttachmentInput?
        var hadOneofValue = false
        if let current = self.input {
          hadOneofValue = true
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .getUpdates?: try {
      guard case .getUpdates(let v)? = self.input else { preconditionFailure() }
    ...
    case .listBots?: try {
      guard case .listBots(let v)? = self.input else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 34)
    }()
    case .revealBotToken?: try {
      guard case .revealBotToken(let v)? = self.input else { preconditionFailure() }
    ...
    case .getMessages?: try {
      guard case .getMessages(let v)? = self.input else { preconditionFailure() }
    ...
    case .createSubthread?: try {
      guard case .createSubthread(let v)? = self.input else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 43)
    }()
    case .getBotCommands?: try {
      guard case .getBotCommands(let v)? = self.input else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 44)
    }()
    case .setBotCommands?: try {
      guard case .setBotCommands(let v)? = self.input else { preconditionFailure() }
    ...
    case .reserveChatIds?: try {
      guard case .reserveChatIds(let v)? = self.input else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 48)
    }()
    case .invokeMessageAction?: try {
      guard case .invokeMessageAction(let v)? = self.input else { preconditionFailure() }
...
extension UpdateBucket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateBucket, rhs: UpdateBucket) -> Bool {
    if lhs.type != rhs.type {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension UpdateBucketUser: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateBucketUser, rhs: UpdateBucketUser) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension UpdateBucketSpace: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateBucketSpace, rhs: UpdateBucketSpace) -> Bool {
    if lhs.spaceID != rhs.spaceID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension UpdateBucketChat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateBucketChat, rhs: UpdateBucketChat) -> Bool {
    if lhs._peerID != rhs._peerID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension GetUpdatesInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.startSeq != 0 {
      try visitor.visitSingularInt64Field(value: self.startSeq, fieldNumber: 2)
    }
    if self.totalLimit != 0 {
      try visitor.visitSingularInt32Field(value: self.totalLimit, fieldNumber: 3)
    }
    if self.seqEnd != 0 {
  ...
  public static func ==(lhs: GetUpdatesInput, rhs: GetUpdatesInput) -> Bool {
...
extension GetUpdatesResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetUpdatesResult, rhs: GetUpdatesResult) -> Bool {
    if lhs.updates != rhs.updates {return false}
    if lhs.seq != rhs.seq {return false}
    if lhs.date != rhs.date {return false}
...
extension UpdateMemberAccessInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateMemberAccessInput, rhs: UpdateMemberAccessInput) -> Bool {
    if lhs.spaceID != rhs.spaceID {return false}
    if lhs.userID != rhs.userID {return false}
    if lhs._role != rhs._role {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension GetChatResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _anchorMessage = source._anchorMessage
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._anchorMessage) }()
        default: break
        }
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._anchorMessage {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      } }()
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  public static func ==(lhs: GetChatResult, rhs: GetChatResult) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._anchorMessage != rhs_storage._anchorMessage {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension ListBotsInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ListBotsInput, rhs: ListBotsInput) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension DeleteMessageAttachmentInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularMessageField(value: &self._peerID) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.messageID) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.attachmentID) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.attachmentID != 0 {
      try visitor.visitSingularInt64Field(value: self.attachmentID, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: DeleteMessageAttachmentInput, rhs: DeleteMessageAttachmentInput) -> Bool {
    if lhs._peerID != rhs._peerID {return false}
    if lhs.messageID != rhs.messageID {return false}
...
extension DeleteMessageAttachmentResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: DeleteMessageAttachmentResult, rhs: DeleteMessageAttachmentResult) -> Bool {
    if lhs.updates != rhs.updates {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension BotCommand: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularInt32Field(value: &self._sortOrder) }()
      default: break
      }
    }
  }
...
extension GetBotCommandsInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetBotCommandsInput, rhs: GetBotCommandsInput) -> Bool {
    if lhs.botUserID != rhs.botUserID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension GetBotCommandsResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetBotCommandsResult, rhs: GetBotCommandsResult) -> Bool {
...
extension SetBotCommandsInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: SetBotCommandsInput, rhs: SetBotCommandsInput) -> Bool {
    if lhs.botUserID != rhs.botUserID {return false}
    if lhs.commands != rhs.commands {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension SetBotCommandsResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: SetBotCommandsResult, rhs: SetBotCommandsResult) -> Bool {
    if lhs.commands != rhs.commands {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension GetPeerBotCommandsInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetPeerBotCommandsInput, rhs: GetPeerBotCommandsInput) -> Bool {
    if lhs._peerID != rhs._peerID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension GetPeerBotCommandsResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetPeerBotCommandsResult, rhs: GetPeerBotCommandsResult) -> Bool {
    if lhs.bots != rhs.bots {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension RevealBotTokenInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: RevealBotTokenInput, rhs: RevealBotTokenInput) -> Bool {
    if lhs.botUserID != rhs.botUserID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension DialogNotificationSettings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: DialogNotificationSettings, rhs: DialogNotificationSettings) -> Bool {
    if lhs._mode != rhs._mode {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension UpdateDialogNotificationSettingsInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._peerID) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._notificationSettings) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: UpdateDialogNotificationSettingsInput, rhs: UpdateDialogNotificationSettingsInput) -> Bool {
    if lhs._peerID != rhs._peerID {return false}
    if lhs._notificationSettings != rhs._notificationSettings {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension UpdateDialogNotificationSettingsResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateDialogNotificationSettingsResult, rhs: UpdateDialogNotificationSettingsResult) -> Bool {
    if lhs.updates != rhs.updates {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension EditMessageInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 9: try { try decoder.decodeSingularMessageField(value: &self._actions) }()
      default: break
      }
    }
  }
...
extension SendMessageInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularMessageField(value: &self._actions) }()
...
extension InvokeMessageActionInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: InvokeMessageActionInput, rhs: InvokeMessageActionInput) -> Bool {
    if lhs._peerID != rhs._peerID {return false}
    if lhs.messageID != rhs.messageID {return false}
    if lhs.actionID != rhs.actionID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension InvokeMessageActionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.interactionID) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.interactionID != 0 {
      try visitor.visitSingularInt64Field(value: self.interactionID, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: InvokeMessageActionResult, rhs: InvokeMessageActionResult) -> Bool {
...
extension AnswerMessageActionInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.interactionID) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._ui) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: AnswerMessageActionInput, rhs: AnswerMessageActionInput) -> Bool {
    if lhs.interactionID != rhs.interactionID {return false}
...
extension AnswerMessageActionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: AnswerMessageActionResult, rhs: AnswerMessageActionResult) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension GetMessagesInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetMessagesInput, rhs: GetMessagesInput) -> Bool {
    if lhs._peerID != rhs._peerID {return false}
    if lhs.messageIds != rhs.messageIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension ReserveChatIdsInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ReserveChatIdsInput, rhs: ReserveChatIdsInput) -> Bool {
...
extension ReservedChatId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ReservedChatId, rhs: ReservedChatId) -> Bool {
    if lhs.chatID != rhs.chatID {return false}
...
extension ReserveChatIdsResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: ReserveChatIdsResult, rhs: ReserveChatIdsResult) -> Bool {
...
extension CreateSubthreadInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.parentChatID) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self._parentMessageID) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    if self.parentChatID != 0 {
      try visitor.visitSingularInt64Field(value: self.parentChatID, fieldNumber: 1)
    }
    try { if let v = self._parentMessageID {
      try visitor.visitSingularInt64Field(value: v, fieldNumber: 2)
    } }()
  ...
  public static func ==(lhs: CreateSubthreadInput, rhs: CreateSubthreadInput) -> Bool {
...
extension CreateSubthreadResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._chat) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._dialog) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._anchorMessage) }()
        default: break
        }
      }
    }
  ...
  public static func ==(lhs: CreateSubthreadResult, rhs: CreateSubthreadResult) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension UpdateChatMoved: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt64Field(value: &self._oldSpaceID) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self._newSpaceID) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._oldSpaceID {
      try visitor.visitSingularInt64Field(value: v, fieldNumber: 2)
    } }()
    try { if let v = self._newSpaceID {
      try visitor.visitSingularInt64Field(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: UpdateChatMoved, rhs: UpdateChatMoved) -> Bool {
    ...
    if lhs._newSpaceID != rhs._newSpaceID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension UpdateSpaceMemberUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateSpaceMemberUpdate, rhs: UpdateSpaceMemberUpdate) -> Bool {
...
extension UpdateChatOpen: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateChatOpen, rhs: UpdateChatOpen) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension UpdateMessageActionInvoked: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateMessageActionInvoked, rhs: UpdateMessageActionInvoked) -> Bool {
    if lhs.interactionID != rhs.interactionID {return false}
    if lhs.chatID != rhs.chatID {return false}
    if lhs.messageID != rhs.messageID {return false}
...
extension UpdateMessageActionAnswered: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: UpdateMessageActionAnswered, rhs: UpdateMessageActionAnswered) -> Bool {
    if lhs.interactionID != rhs.interactionID {return false}
    if lhs._ui != rhs._ui {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension MoveThreadInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MoveThreadInput, rhs: MoveThreadInput) -> Bool {
    if lhs.chatID != rhs.chatID {return false}
    if lhs._spaceID != rhs._spaceID {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension MoveThreadResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: MoveThreadResult, rhs: MoveThreadResult) -> Bool {
    if lhs._chat != rhs._chat {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
