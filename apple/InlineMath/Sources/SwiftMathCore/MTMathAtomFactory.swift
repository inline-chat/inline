  ...
  //  public static let sharedInstance = MTMathAtomFactory()
    ...
    public static func atom(forCharacter ch: Character) -> MTMathAtom? {
        ...
        switch chStr {
            ...
            case _ where ch.unicodeScalars.count != 1:
                // Font-style conversion operates on one scalar. Preserve an
                // unsupported grapheme as source instead of dropping marks.
                return nil
