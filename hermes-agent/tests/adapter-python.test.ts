...
assert probe_payload["pluginVersion"] == "0.0.12"
...
assert credential_request.get_header("User-agent") == "inline-hermes-agent-adapter/0.0.12"
...
assert config_probe_requests[0].get_header("User-agent") == "inline-hermes-agent-adapter/0.0.12"
