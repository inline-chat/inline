...
Customer is the controller of Customer Personal Data. Inline is the processor of Customer Personal Data, except where Inline processes limited account, billing, security, or operational data as an independent controller as described in the [Privacy Policy](/legal/privacy).
...
Customer authorizes Inline to use Subprocessors to provide the Services. Inline's current Subprocessor list is available at [Subprocessors](/legal/subprocessors).
...
Privacy and DPA requests can be sent to [hey@inline.chat](mailto:hey@inline.chat).
