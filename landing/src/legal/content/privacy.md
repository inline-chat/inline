...
No internet service can guarantee absolute security. If you believe you found a vulnerability, contact [hey@inline.chat](mailto:hey@inline.chat) with the subject line `Security`.
...
For privacy questions or requests, email [hey@inline.chat](mailto:hey@inline.chat).
