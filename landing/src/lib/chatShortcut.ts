...
export function chatShortcutResponse(chatId: string, includeBody = true): Response {
  ...
  const body = includeBody
    ? `<!doctype html><meta charset="utf-8"><meta name="robots" content="noindex,nofollow,noarchive,nosnippet"><meta name="referrer" content="no-referrer"><meta http-equiv="refresh" content="0;url=${deepLink}"><title>Open in Inline</title>`
    : null
