...
Most integrations should install `@inline-chat/bot-api`, which re-exports these types and includes the HTTP client. Install this package directly when only the wire types are needed.
