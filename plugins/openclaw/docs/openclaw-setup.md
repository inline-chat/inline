...
- OpenClaw `2026.8.2` and newer, including `2026.9.x`: Inline plugin `0.0.71` — `openclaw plugins install npm:@inline-openclaw/inline@0.0.71 --force --accept-capabilities`
