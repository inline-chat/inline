...
const files: Array<{ source: string; destination: string }> = [
  ...
  {
    source: "packages/protocol/trust-roots/inline-protocol-production.json",
    destination: "packages/protocol/trust-roots/inline-protocol-production.json",
  },
  {
    source: "packages/protocol/docs/realtime-v3-rpc-semantics.md",
    destination: "packages/protocol/docs/realtime-v3-rpc-semantics.md",
  },
  { source: "packages/protocol/package.json", destination: "packages/protocol/package.json" },
