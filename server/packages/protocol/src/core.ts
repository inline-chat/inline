...
export interface RpcCall {
    ...
    input: {
        ...
        /**
         * @generated from protobuf field: GetUpdatesStateInput getUpdatesState = 24;
         */
...
export interface RpcResult {
    ...
    result: {
        ...
        oneofKind: "getUpdatesState";
        /**
         * @generated from protobuf field: GetUpdatesStateResult getUpdatesState = 24;
         */
...
export enum Method {
    ...
    DELETE_MEMBER = 22,
    /**
     * @generated from protobuf enum value: GET_UPDATES_STATE = 23;
     */
    GET_UPDATES_STATE = 23
}
...
class RpcCall$Type extends MessageType<RpcCall> {
    constructor() {
        super("RpcCall", [
            ...
            { no: 24, name: "getUpdatesState", kind: "message", oneof: "input", T: () => GetUpdatesStateInput }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* DeleteMemberInput deleteMember */ 23:
                    ...
                    break;
                case /* GetUpdatesStateInput getUpdatesState */ 24:
                    message.input = {
                        oneofKind: "getUpdatesState",
    ...
    internalBinaryWrite(message: RpcCall, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* GetUpdatesStateInput getUpdatesState = 24; */
        if (message.input.oneofKind === "getUpdatesState")
            GetUpdatesStateInput.internalBinaryWrite(message.input.getUpdatesState, writer.tag(24, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class RpcResult$Type extends MessageType<RpcResult> {
    constructor() {
        super("RpcResult", [
            ...
            { no: 24, name: "getUpdatesState", kind: "message", oneof: "result", T: () => GetUpdatesStateResult }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* DeleteMemberResult deleteMember */ 23:
                    ...
                    break;
                case /* GetUpdatesStateResult getUpdatesState */ 24:
                    message.result = {
                        oneofKind: "getUpdatesState",
    ...
    internalBinaryWrite(message: RpcResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* GetUpdatesStateResult getUpdatesState = 24; */
        if (message.result.oneofKind === "getUpdatesState")
            GetUpdatesStateResult.internalBinaryWrite(message.result.getUpdatesState, writer.tag(24, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
