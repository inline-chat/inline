...
const makeOAuthHandlers = (
  ...
  providerNativeAppleStart: async () => unused("providerNativeAppleStart"),
  providerNativeAppleComplete: async () => unused("providerNativeAppleComplete"),
  providerNativeAppleContinueInvite: async () => unused("providerNativeAppleContinueInvite"),
