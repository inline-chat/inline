...
export const CHATGPT_BOT_ENABLED = process.env["CHATGPT_BOT_ENABLED"]
export const CHATGPT_PROVIDER_TOOLS_ENABLED = process.env["CHATGPT_PROVIDER_TOOLS_ENABLED"]
...
const optionalVariables = [
  ...
  "CHATGPT_BOT_ENABLED",
  "CHATGPT_PROVIDER_TOOLS_ENABLED",
  "NOTION_CLIENT_ID",
