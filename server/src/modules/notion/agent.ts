...
import { WORKSPACE_TRANSLATION_CONTEXT } from "@in/server/env"
...
async function createNotionPage(input: {
  ...
  We have an active team named Example. They will mostly use your service to create tasks from messages in a chat. this is related context about them:
  ${WORKSPACE_TRANSLATION_CONTEXT}.
