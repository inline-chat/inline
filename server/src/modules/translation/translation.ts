...
import { isProd, WORKSPACE_TRANSLATION_CONTEXT } from "@in/server/env"
...
if (!WORKSPACE_TRANSLATION_CONTEXT && isProd) {
  log.warn("WORKSPACE_TRANSLATION_CONTEXT is not available")
}
