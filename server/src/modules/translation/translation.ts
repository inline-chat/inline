  ...
  const response = await openaiClient.chat.completions.create({
    ...
    messages: [
      ...
      },
      {
        ...
        This chat is part of Example workspace, a company for streamers selling stuff online. It has a warehouse, it processes products, it builds a software called example.test to facilitate selling. They operate in Taiwan and Canada. They have several shops called Amy Shop, Pan pan, Crazy Shop, etc. 
        </context>
