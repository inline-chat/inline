...
export const ApiError = {
  ...
  INVITE_CODE_REQUIRED: ["INVITE_CODE_REQUIRED", 400, "Enter an invite code to sign up."],
  INVITE_CODE_INVALID: ["INVITE_CODE_INVALID", 400, "Invite code must be 8 letters or numbers."],
