...
import { useClientDb } from "../react/InlineClientContext"
import { DbModels, DbObjectKind } from "./models"
import { type DbObjectId, DbObjectRef, DbQueryPlanType } from "./types"

const defaultPredicate = () => true

/** Get a stable ref for a given kind and id. Returns undefined if id is undefined. */
export function useObjectRef<K extends DbObjectKind>(
  kind: K,
